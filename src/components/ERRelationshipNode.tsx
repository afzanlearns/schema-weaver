...
const ERRelationshipNode = ({ data }: NodeProps) => {
  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: 100, height: 100 }}>
      ...
      <div
        className="er-relationship-shape absolute inset-0 bg-[#E3E9F2] dark:bg-[#1B2335] border-[1.5px] border-primary/50 transition-all duration-200 hover:border-primary dark:shadow-[0_4px_16px_rgba(0,0,0,0.5)]"
        style={{
